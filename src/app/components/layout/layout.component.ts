...
export class LayoutComponent implements OnInit {
  ...
  constructor(public authService: AuthService, /*private changeLangService: ChangeLangService,*/
    public TabService: TabsServiceService, private router: Router, public translate: TranslateService,
  ...
  layoutItem(e) {
    ...
    for (let _i = 0; _i < $('.mat_item_a').length; _i++) {
  ...
  removeTab(path, label) {
    const Tab: tab = { path: path, label: label };
